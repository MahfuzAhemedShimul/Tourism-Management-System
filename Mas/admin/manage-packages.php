...
<html>
<head>
<title>MAS | admin manage packages</title>
...
{				?>		
    ...
    (৳<?php 
        $conversionRate = 110; // Example conversion rate from USD to Bangla Taka
        $priceInBangla = $result->PackagePrice * $conversionRate;
        echo htmlentities(number_format($priceInBangla, 2));
    ?>)
</td>
