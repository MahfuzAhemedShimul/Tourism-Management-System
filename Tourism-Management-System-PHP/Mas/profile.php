...
<html>
<head>
<title>MAS | Mahfuz Ahmed Shimul Travel Agency</title>
...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">Mas Travel Agency</h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- privacy ---->
...
<p style="width: 350px;">
<b>Mobile Number</b>
<input type="text" class="form-control" name="mobile_no" maxlength="11" value="<?php echo htmlentities($result->MobileNumber);?>" id="mobileno"  required="">
</p>
